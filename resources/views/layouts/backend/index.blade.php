...
<head>
  ...
  <title>Lectors Hub - Dashboard</title>
...
<body>
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega navbar-expand-md"
    ...
    <div class="navbar-header">
      ...
      <div class="navbar-brand navbar-brand-center">
        <img class="navbar-brand-logo" src="{{ asset('backend/assets/images/b_logo.png') }}" title="Lectors Hub">
        <span class="navbar-brand-text hidden-xs-down"> Lectors Hub</span>
      </div>
  ...
  <footer class="site-footer">
    <div class="site-footer-legal">© {{ date('Y') }} <a href="javascript:void(0)">Lectors Hub</a></div>
  </footer>
  <!-- Core  -->
