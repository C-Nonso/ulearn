...
<title>Lectors Hub - Learning Management System</title>
...
<br>
<span id="c-copyright">
                    Copyright © 2025, DigitBlend. All rights reserved.
</span>
</div>
</div>
</footer>
...
<!-- PayPal ID field removed - All courses are FREE -->
<div class="form-group">
...
$("#becomeInstructorForm").validate({
                ...
                messages: {
                    ...
                    contact_email: { required: 'The contact email field is required.', email: 'The contact email must be a valid email address.' },
